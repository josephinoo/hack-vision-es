    ...
    >
      ...
      <div className="flex flex-col items-center gap-1 rounded-lg bg-slate-800/60 py-3">
        {penaltyMode ? (
          <>
            <img
              src="/images/billete.png"
              alt=""
              className="h-12 w-auto object-contain"
            />
            <p className="text-center text-sm font-medium text-amber-300">
              Billetes cogidos: {billetes}
            </p>
            <p className="text-center text-xs text-amber-200/80">¡Solo coge billetes!</p>
          </>
        ) : (
          <>
      ...
      {penaltyMode ? (
        <p className="text-center text-xs text-amber-400/90">
          {isLeft ? '← Coge billetes aquí' : 'Coge billetes aquí →'}
        </p>
      ) : isLeft ? (
